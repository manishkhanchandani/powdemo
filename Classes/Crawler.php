...
class Crawler {
	...
	public function insertRestaurant($post) {
		...
		$sql = "INSERT INTO `restaurants` ( `id` , `rid` , `state` , `city` , `address` , `neighborhood` , `country` , `location` ,`phone` , `zip` , `linktext` , `title` ,`full_neighborhood` , `full_city` , `pricerange` , `dollarcount` , `cusine`, `lat`, `lon` ) VALUES ( '".addslashes(stripslashes(trim($post['id'])))."', '".addslashes(stripslashes(trim($post['rid'])))."' , '".addslashes(stripslashes(trim($post['province'])))."' , '".addslashes(stripslashes(trim($post['city'])))."' , '".addslashes(stripslashes(trim($post['streeaddr'])))."' , '".addslashes(stripslashes(trim($post['neighbour'])))."' , '".addslashes(stripslashes(trim($post['country'])))."' , '".addslashes(stripslashes(trim($post['city']))).", ".addslashes(stripslashes(trim($post['province'])))."', '".addslashes(stripslashes(trim($post['phone'])))."' , '".addslashes(stripslashes(trim($post['zip'])))."' , '".addslashes(stripslashes(trim($post['linktext'])))."' , '".addslashes(stripslashes(trim($post['title'])))."' , '".addslashes(stripslashes(trim($post['folder'].", ".$post['city'].", ".$post['province'])))."' , '".addslashes(stripslashes(trim($post['city'].", ".$post['province'])))."' , '".addslashes(stripslashes(trim($post['pricerange'])))."' , '".addslashes(stripslashes(trim($post['dollarcount'])))."' , '".addslashes(stripslashes(trim($cuisine)))."', '".addslashes(stripslashes(trim($post['lat'])))."', '".addslashes(stripslashes(trim($post['lon'])))."' )";
		echo $sql;
		echo "<br>";
		@mysql_query($sql);
		$ID = mysql_insert_id();
